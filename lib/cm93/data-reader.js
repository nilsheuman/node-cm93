import {
    ...
    ATTR_TYPE_FLOAT, ATTR_TYPE_BYTE, ATTR_TYPE_STRING, ATTR_TYPE_COMPLEX_STRING, ATTR_TYPE_WORD,
    ATTR_TYPE_LONG, ATTR_TYPE_LIST, ATTR_TYPE_NOT_USED, ATTR_TYPE_UNKNOWN
 } from './constants.js';
import {
    readAndDecodeByte, 
    readAndDecodeUShort, 
            ...
            case GEO_TYPE_AREA:
                {
                    ...
                    for (let j = 0; j < nElements; j++) {
                        ...
                        offset += SHORT;
                        feature.vectorIndexes.push(index)
...
export function readAttributes(buffer, offset, objDescBytes, dictionary) {
    ...
    for (let j = 0; j < nAttributes; j++) {
        ...
        const attrEntry = dictionary.get(attrId) || {}
        const attrName = attrEntry.name || 'a_' + j
        const attrType = attrEntry.type || ATTR_TYPE_UNKNOWN
        ...
        switch (attrType) {
            ...
            case ATTR_TYPE_FLOAT:
                ...
                break;
            default:
                console.log('unhandled attr', {attrId, attrType})
